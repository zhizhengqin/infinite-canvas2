export default {
    ...
    canvas: {
        ...
        agentConnecting: "{{name}} {{activity}}",
        agentDisconnected: "{{name}} disconnected",
    ...
    navigation: { canvas: "My Canvases", image: "Image Studio", video: "Video Studio", prompts: "Prompt Library", assets: "My Assets", config: "Settings" },
    topNav: {
    ...
    config: {
        ...
        agent: {
            title: "Local Agent",
            description: "Choose the local Agent used by the canvas Agent panel. Switching disconnects the current session and reconnects.",
            hint: { codex: "Requires the Codex CLI installed and signed in locally, or the Codex plugin", kimi: "Requires the Kimi Code CLI (kimi) installed and signed in locally" },
            connection: "Connection: {{status}} · {{url}}",
        },
        proxy: {
            title: "Local proxy",
        ...
        promptSources: {
            ...
            content: { loadFailed: "Failed to fetch prompts", title: "{{name}} · Prompt content", count: "{{count}} prompts", refresh: "Update now", empty: "No prompts", cover: "Cover", titleColumn: "Title", tags: "Tags", actions: "Actions" },
            runtime: {
        ...
        channelEditor: {
            ...
            runningHub: {
                title: "RunningHub workflow / AI app",
                description: "Import reads node metadata only and does not create a generation task. Charges occur only when you click Generate in a studio or canvas.",
                memberKey: "Member API Key",
                keyPlaceholder: "Enter your RunningHub member key",
                link: "RunningHub link or numeric ID",
                linkPlaceholder: "https://www.runninghub.cn/workflow/...",
                itemName: "Item name",
                itemNamePlaceholder: "For example: Seedance multimodal video",
                kind: "Target type",
                workflow: "Workflow",
                app: "AI app",
                capability: "Output type",
                import: "Read and import",
                imported: "Imported {{count}} configurable fields",
                importFailed: "Failed to import the RunningHub target",
                ...
                sources: {
                    ...
                    ratio: "Aspect ratio",
                    resolution: "Resolution",
                    generateAudio: "Generate audio switch",
    ...
    agent: {
        ...
        types: { codex: "Codex", kimi: "Kimi Code" },
        ...
        eventMore: { toolRunning: "{{action}}…", openedRoute: "Opened {{route}}", canvasCount: "{{count}} canvases", promptCount: "Found {{count}} prompts", assetCount: "{{count}} assets", assetAdded: "Added to My Assets", generationStatus: "{{total}} tasks: {{queued}} queued, {{running}} running, {{succeeded}} succeeded, {{failed}} failed", workbenchExecuted: "Executed in the workbench", workbenchConfigRead: "Workbench configuration read", canvasRead: "Current canvas read", selectionRead: "Current selection read", textNodes: "{{count}} text nodes", imageNodes: "{{count}} images", configNodes: "{{count}} config nodes", videoNodes: "{{count}} videos", audioNodes: "{{count}} audio nodes", groupNodes: "{{count}} groups", otherNodes: "{{count}} other nodes", connections: "{{count}} connections", emptyCanvas: "The canvas is empty", executeTool: "Run {{tool}}", thinking: "Thinking...", operationRunning: "{{operation}} is running...", organizingCanvas: "Canvas read; {{name}} is organizing the result...", operationCompleted: "{{operation}} completed; {{name}} is continuing...", attachmentPrompt: "Please process the uploaded image attachments.", routes: { home: "Home", canvas: "Canvas", canvasProject: "Selected canvas", image: "Image Studio", video: "Video Studio", prompts: "Prompt Center", assets: "My Assets", config: "Settings" } },
        runtime: {
            mcpStarting: "Starting MCP: {{name}}", mcpConnecting: "Connecting tools and loading the available tool list", mcpReadyNamed: "MCP ready: {{name}}", toolsReady: "Tool list loaded. You can start chatting.", mcpFailedNamed: "MCP failed to start: {{name}}", mcpCanceledNamed: "MCP startup canceled: {{name}}", toolInitFailed: "The tool service could not finish initializing", mcpServicesStarting: "Starting MCP services", toolServicesPending: "{{count}} tool services are still initializing", checkingToolServices: "Checking tool service status", conversationInitializing: "Initializing the {{name}} conversation", conversationCreating: "Creating the conversation and starting canvas tools", someMcpFailed: "Some MCP services failed to initialize", remainingToolsReady: "The remaining tools are ready. You can start chatting.", conversationInitFailed: "{{name}} conversation initialization failed", conversationCreateFailed: "Could not create the {{name}} conversation", mcpServicesReady: "{{count}} MCP services initialized", toolInitCanceled: "Tool service initialization was canceled", mcpStatusComplete: "MCP status check completed", mcpListRead: "Loaded the complete tool service list returned by {{name}}",
            historyReadFailed: "Failed to read history", conversationSyncFailed: "Failed to sync conversation", agentOutdated: "The local Agent is outdated. Restart Canvas Agent and reconnect.", restartRequired: "Agent restart required", versionMismatch: "Agent version mismatch", awaitingApproval: "Awaiting approval", agentRunning: "{{name}} is running", connected: "Connected", localAgentConnected: "Local Agent connected", processingFailed: "Processing failed", completed: "Completed", approvalGranted: "Permission approved", approvalCanceled: "Permission canceled", log: "Log", connectionLostDescription: "The local Agent connection failed or was interrupted", connectionFailedDescription: "Connection failed. Check the address and token.", connectionLost: "Connection lost", connectionFailed: "Connection failed", modelListFailed: "Failed to load model list",
